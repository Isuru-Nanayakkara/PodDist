Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
                       ...
                       DESC
  s.homepage         = 'https://github.com/Isuru-Nanayakkara/PodDist'
  s.author           = { 'Isuru Nanayakkara' => 'isuru.nan@gmail.com' }
  s.source           = { :http => 'https://github.com/Isuru-Nanayakkara/PodDist/releases/download/1.0.0/QRSDK.xcframework.zip' }
